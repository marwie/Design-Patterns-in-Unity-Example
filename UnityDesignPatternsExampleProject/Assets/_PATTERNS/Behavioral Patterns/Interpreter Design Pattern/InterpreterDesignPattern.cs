...
/*
 * "The interpreter pattern is normally ignored" < great way to start :)
 * "This pattern is almost never used" < also good
 * 
 * Derek Barnas: "I find it to be extremely useful if combined with Java Reflection techniques"
 * Derek Barnas: "I was able to put together the zork videogame adventure with those two that night"
 * 
 * ====================================
 ...
 * The Expression is an abstract class that defines all the methods needed to perform the different converions
 * The Terminal or Concrete Expressions provide specific conversions on different types of data
 * 
 * ====================================
 * 
 * Video: https://www.youtube.com/watch?v=6CVymSJQuJE&list=PLF206E906175C7E07&index=23
 * 
 * */
