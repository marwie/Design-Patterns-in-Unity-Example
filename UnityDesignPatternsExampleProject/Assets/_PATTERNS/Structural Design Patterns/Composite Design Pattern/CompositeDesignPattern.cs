...
/*
 * Allows to treat individual objects and compositions of of objects unifrmly
 * 
 * They allow you to represent part-whole hierarchies: it is when components can further be divided into smaller and smaller components
 * 
 * Allows to structure date or represent the inner working of every part of a whole object individually
 * 
 * 
 * Example Objects:
 * 
 ...
 * Song <= Leaf
 * 
 * then a SongGroup can contain Songs but also other SongGroups
 * 
 * 
 * Maybe think of it as folders containing files but also more folders
 * 
 * */
